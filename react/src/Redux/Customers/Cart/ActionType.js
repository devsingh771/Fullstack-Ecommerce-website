// 2. Action Types (actiontype.jsx)
// Action types are constants that represent the types of actions that can be dispatched. They ensure consistency and avoid typos.export const ADD_ITEM_TO_CART_REQUEST = 'ADD_ITEM_TO_CART_REQUEST';
